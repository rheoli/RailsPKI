...
class SSLDispatchServlet < DispatchServlet
  def self.dispatch(options)
    ...
    server = WEBrick::HTTPServer.new(
      ...
      :SSLEnable       => true,
      :SSLXVerifyClient => ::OpenSSL::SSL::VERIFY_NONE, # | ::OpenSSL::SSL::VERIFY_FAIL_IF_NO_PEER_CERT,
      :SSLVerifyClient => ::OpenSSL::SSL::VERIFY_PEER | ::OpenSSL::SSL::VERIFY_FAIL_IF_NO_PEER_CERT,
      :SSLVerifyDepth  => 4,
      :SSLClientCA     => [::OpenSSL::X509::Certificate.new(File.read(RAILS_ROOT + "/config/ssl/rails_pki_client_ca.crt"))],
